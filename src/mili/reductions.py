...
reduce_functions = {
  "append_state": zeroth_entry,
  "all_labels_of_material": dictionary_merge_concat,

  "containing_state_variables_of_class": list_concatenate_unique_str,
  "copy_non_state_data": zeroth_entry,
  "class_labels_of_material": list_concatenate,
  "class_names": list_concatenate_unique_str,
  "classes_of_state_variable": list_concatenate_unique_str,
  "classes_of_derived_variable": list_concatenate_unique_str,
  "components_of_vector_svar": list_concatenate_unique_str,
  "connectivity": reduce_connectivity,

  "derived_variables_of_class": list_concatenate_unique_str,

  "element_sets": dictionary_merge_no_concat,

  "int_points_of_state_variable": list_concatenate_unique,
  "integration_points": dictionary_merge_no_concat,

  "labels": reduce_labels,

  "material_classes": list_concatenate_unique_str,
  "material_numbers": list_concatenate_unique,
  "materials": zeroth_entry,
  "materials_of_class_name": list_concatenate,
  "mesh_dimensions": zeroth_entry,

  "nodes_of_elems": reduce_nodes_of_elems,
  "nodes_of_material": list_concatenate_unique,

  "parts_of_class_name": list_concatenate,

  "query": combine,
  "queriable_svars": list_concatenate_unique_str,

  "reload_state_maps": zeroth_entry,

  "srec_fmt_qty": zeroth_entry,
  "state_maps": zeroth_entry,
  "supported_derived_variables": zeroth_entry,
